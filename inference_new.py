...
if __name__ == "__main__":
	...
	for idx, batch in enumerate(val_dataset):
		...
		print(args.fixed_fov, args.predict_camera_motion, args.cached_motion_path, args.cached_motion_npz_path, args.equirectangular_input)
		print('has_fov', 'fov' in batch, 'has_motion', 'motion' in batch)
		print(
			"DEBUG",
			"path:", path,
